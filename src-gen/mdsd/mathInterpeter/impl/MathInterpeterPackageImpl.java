 ...
 * @generated
 */
public class MathInterpeterPackageImpl extends EPackageImpl implements MathInterpeterPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see mdsd.mathInterpeter.MathInterpeterPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MathInterpeterPackageImpl()
  {
    super(eNS_URI, MathInterpeterFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link MathInterpeterPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MathInterpeterPackage init()
  {
    if (isInited) return (MathInterpeterPackage)EPackage.Registry.INSTANCE.getEPackage(MathInterpeterPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMathInterpeterPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MathInterpeterPackageImpl theMathInterpeterPackage = registeredMathInterpeterPackage instanceof MathInterpeterPackageImpl ? (MathInterpeterPackageImpl)registeredMathInterpeterPackage : new MathInterpeterPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theMathInterpeterPackage.createPackageContents();

    // Initialize created meta-data
    theMathInterpeterPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMathInterpeterPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MathInterpeterPackage.eNS_URI, theMathInterpeterPackage);
    return theMathInterpeterPackage;
  }
   ...
   */
  @Override
  public MathInterpeterFactory getMathInterpeterFactory()
  {
    return (MathInterpeterFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(numberEClass, mdsd.mathInterpeter.Number.class, "Number", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNumber_Value(), ecorePackage.getEInt(), "value", null, 0, 1, mdsd.mathInterpeter.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
